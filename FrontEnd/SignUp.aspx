            ...
            <form>
                <table>
                    ...
                    <tr>
                        <td>Email</td>
                        <td>
                            <input type="email" value="" placeholder="last name" />
                        </td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td>
                            <input type="password" value="" placeholder="At least 8 chars" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" value=""placeholder="state / province / region"/>
                        </td>
                    </tr>
                    <tr>
                        <td>Zip / Postal Code</td>
                        <td>
                            <input type="text" value="" placeholder="post code" />
                        </td>
                    </tr>
                    <tr>
                        <td>Country</td>
